...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Generate offline BMO audio from teacher checkpoint.")
    parser.add_argument("--ckpt", default="v5_step1500.safetensors")
    ...
    parser.add_argument("--out", default="teacher_output.wav")
