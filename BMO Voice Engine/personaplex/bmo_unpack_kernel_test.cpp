...
extern "C" __global__ void unpack_kernel(
    const uint8_t * packed_weights,
    const uint8_t * packed_mask,
    int rows,
    int cols,
...
extern "C" __global__ void apply_fp16_overrides(const int32_t * fp16_idx, const float * fp16_vals, int64_t n_fp16, __half * out_half) {
