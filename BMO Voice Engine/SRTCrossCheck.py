...
METADATA_CSV = r"D:\downloads\BMO_SpeechDataset\BMO_SpeechDataset\metadata.csv"  # path to your metadata.csv
SRT_DIR      = r"C:\Users\raouy\OneDrive\Documents\GitHub\BMO Project\BMO-Project\BMO Voice Engine\srtfiles"   # folder where *.srt files live
OUTPUT_DIR   = r"D:\downloads\BMO_SpeechDataset\BMO_SpeechDataset"  # folder where output files will be saved
